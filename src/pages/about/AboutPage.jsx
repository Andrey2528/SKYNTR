...
const AboutPage = () => {
    ...
    return (
        <div className="about">
            <RuneParticles NUMBER_OF_RUNES={RUNES_COUNT} />
            ...
            <div className="about__content">
                <blockquote className="about__quote">
                    "У світі, де дані — нова магія, Skyntr — це код, викарбуваний рунами."
                </blockquote>
                <Trans i18nKey="about.mission" components={{ 1: <br /> }} />
                <Trans i18nKey="about.philosophy" components={{ 1: <br /> }} />
            ...
            <div className="about__timeline">
                <div className="timeline-item" data-rune="ᚠ">
                    <h3>Початок</h3>
                    <p>Ідея Skyntr виникла як синтез коду й символів давнини.</p>
                </div>
                ...
                <div className="timeline-item" data-rune="ᛗ">
                    <h3>Місія</h3>
                    <p>Об'єднати технології та міфологію в цифровому просторі.</p>
                </div>
                <div className="timeline-item" data-rune="ᛟ">
                    <h3>Майбутнє</h3>
                    <p>Skyntr розвивається як бренд і філософія творення.</p>
                </div>
            </div>
        </div>
    );
